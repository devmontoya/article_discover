...
demo_input = [ {"name":"The Guardian", "image_url":"https://assets.guim.co.uk/images/guardian-logo-rss.c45beb1bafa34b347ac333af2e6fe23f.png", "url": "https://www.theguardian.com"},
...
function load_pages(channels_list){
  ...
  for(chan in channels_list){
    ...
    channels.push(`<div class="websiteItem"><button class="button-items" onclick="optionFunc(${chan})">
      ...
      <a href=${channels_list[chan]["url"]} target="_blank" class="link-page""><img src="static/images/file-link.png"></img></a></div>`);
  }
